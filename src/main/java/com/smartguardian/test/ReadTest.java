...
public class ReadTest {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < userAddressList.size(); i++) {
			System.out.println(userAddressList.get(i).getId() + " "
					+ userAddressList.get(i).getAddress() + " "
					+ userAddressList.get(i).getAddressNumber());
		}

		System.out.println("User's Phone List:");
		for (int i = 0; i < userPhoneList.size(); i++) {
			System.out.println(userPhoneList.get(i).getId() + " "
					+ userPhoneList.get(i).getPhoneNumber());
		}
